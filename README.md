...
* **A MongoDB Atlas Account:** For hosting your MongoDB database. If you're new to MongoDB, [sign up](https://www.mongodb.com/docs/guides/atlas/account/) and create a cluster in MongoDB Atlas following MongoDB's [documentation](https://www.mongodb.com/docs/guides/atlas/cluster/)
